...
import step3 from './images/option.jpg';
import step4 from './images/select.jpg';
...
const steps = [
  ...
  {
    image: step2,
    description: 'Tap on the Sound and Vibration option.',
    highlightArea: { top: '47%', left: '0%', width: '75%', height: '5%' },
    arrowStyle: { top: '45%', left: '76%', transform: 'translate(-50%, 0)' },
    info: 'Search for Sound and Vibrations and Tap on it.',
  },
  {
    image: step3,
    description: 'Tap on the Ringtone button.',
    highlightArea: { top: '40%', left: '3%', width: '50%', height: '10%' },
    arrowStyle: { top: '42%', left: '55%', transform: 'translate(-50%, 0)' },
    info: 'Tap on "Ringtone" option.',
  },
  {
    image: step4,
    description: 'Choose your preferred Ringtone music.',
    highlightArea: { top: '76%', left: '4%', width: '92%', height: '6%' },
    arrowStyle: { top: '75%', left: '98%', transform: 'translate(-50%, 0)' },
    info: 'Select any Ringtone. Your Ringtone has been set.',
  },
];
