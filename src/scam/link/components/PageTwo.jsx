  ...
  return (
    <div className="page-container" style={{ backgroundImage: `url(${backgroundImage})` }}> {/* Set background image */}
      ...
      <div className="image-container">
        ...
        <button className="image-button2 yes-button2" onClick={handleYesClick}>OK I WILL PAY IMMEADIATELY</button>
        <button className="image-button2 no-button2" onClick={handleNoClick}>No</button>
      </div>
