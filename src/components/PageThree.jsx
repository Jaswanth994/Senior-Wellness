    ...
    <div className="page-container" style={{ backgroundImage: `url(${backgroundImage})` }}>
      ...
      <div className="image-container">
        ...
        <div className="button-container">
          <button className="image-button yes-button" onClick={handleYesClick}>I CLAIM IT</button>
          <button className="image-button no-button" onClick={handleNoClick}>NO I DON'T WANT FREE MONEY</button>
        </div>
      </div>
